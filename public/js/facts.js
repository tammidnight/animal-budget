...
window.addEventListener("load", () => {
  if (bear.checked) {
    ...
    profilePic.innerHTML =
      '<div class="settingsPic" id="mainPic"><img src="/images/bear.png" class="figure-img img-fluid rounded" alt="The users profile pic"><figcaption class="figure-caption">Click on the animals to change me! </figcaption></figure></div>';
  }
  if (cow.checked) {
    div.innerHTML =
    ...
    profilePic.innerHTML =
      '<div class="settingsPic" id="mainPic"><img src="/images/cow.png" class="figure-img img-fluid rounded" alt="The users profile pic"><figcaption class="figure-caption">Click on the animals to change me! </figcaption></figure></div>';
  }
  if (crocodile.checked) {
    ...
    profilePic.innerHTML =
      '<div class="settingsPic" id="mainPic"><img src="/images/crocodile.png" class="figure-img img-fluid rounded" alt="The users profile pic"><figcaption class="figure-caption">Click on the animals to change me! </figcaption></figure></div>';
  }
  if (dog.checked) {
    div.innerHTML =
    ...
    profilePic.innerHTML =
      '<div class="settingsPic" id="mainPic"><img src="/images/dog.png" class="figure-img img-fluid rounded" alt="The users profile pic"><figcaption class="figure-caption">Click on the animals to change me! </figcaption></figure></div>';
  }
  if (duck.checked) {
    div.innerHTML =
    ...
    profilePic.innerHTML =
      '<div class="settingsPic" id="mainPic"><img src="/images/duck.png" class="figure-img img-fluid rounded" alt="The users profile pic"><figcaption class="figure-caption">Click on the animals to change me! </figcaption></figure></div>';
  }
  if (elephant.checked) {
    div.innerHTML =
    ...
    profilePic.innerHTML =
      '<div class="settingsPic" id="mainPic"><img src="/images/elephant.png" class="figure-img img-fluid rounded" alt="The users profile pic"><figcaption class="figure-caption">Click on the animals to change me! </figcaption></figure></div>';
  }
  if (monkey.checked) {
    div.innerHTML =
    ...
    profilePic.innerHTML =
      '<div class="settingsPic" id="mainPic"><img src="/images/monkey.png" class="figure-img img-fluid rounded" alt="The users profile pic"><figcaption class="figure-caption">Click on the animals to change me! </figcaption></figure></div>';
  }
  if (narwhale.checked) {
    div.innerHTML =
    ...
    profilePic.innerHTML =
      '<div class="settingsPic" id="mainPic"><img src="/images/narwhale.png" class="figure-img img-fluid rounded" alt="The users profile pic"><figcaption class="figure-caption">Click on the animals to change me! </figcaption></figure></div>';
  }
  if (owl.checked) {
    div.innerHTML =
    ...
    profilePic.innerHTML =
      '<div class="settingsPic" id="mainPic"><img src="/images/owl.png" class="figure-img img-fluid rounded" alt="The users profile pic"><figcaption class="figure-caption">Click on the animals to change me! </figcaption></figure></div>';
  }
  if (panda.checked) {
    div.innerHTML =
    ...
    profilePic.innerHTML =
      '<div class="settingsPic" id="mainPic"><img src="/images/panda.png" class="figure-img img-fluid rounded" alt="The users profile pic"><figcaption class="figure-caption">Click on the animals to change me! </figcaption></figure></div>';
  }
  if (parrot.checked) {
    div.innerHTML =
    ...
    profilePic.innerHTML =
      '<div class="settingsPic" id="mainPic"><img src="/images/parrot.png" class="figure-img img-fluid rounded" alt="The users profile pic"><figcaption class="figure-caption">Click on the animals to change me! </figcaption></figure></div>';
  }
  if (penguin.checked) {
    div.innerHTML =
    ...
    profilePic.innerHTML =
      '<div class="settingsPic" id="mainPic"><img src="/images/penguin.png" class="figure-img img-fluid rounded" alt="The users profile pic"><figcaption class="figure-caption">Click on the animals to change me! </figcaption></figure></div>';
  }
  if (pig.checked) {
    div.innerHTML =
    ...
    profilePic.innerHTML =
      '<div class="settingsPic" id="mainPic"><img src="/images/pig.png" class="figure-img img-fluid rounded" alt="The users profile pic"><figcaption class="figure-caption">Click on the animals to change me! </figcaption></figure></div>';
  }
  if (walrus.checked) {
    div.innerHTML =
    ...
    profilePic.innerHTML =
      '<div class="settingsPic" id="mainPic"><img src="/images/walrus.png" class="figure-img img-fluid rounded" alt="The users profile pic"><figcaption class="figure-caption">Click on the animals to change me! </figcaption></figure></div>';
  }
  if (whale.checked) {
    div.innerHTML =
    ...
    profilePic.innerHTML =
      '<div class="settingsPic" id="mainPic"><img src="/images/whale.png" class="figure-img img-fluid rounded" alt="The users profile pic"><figcaption class="figure-caption">Click on the animals to change me! </figcaption></figure></div>';
  }
  if (zebra.checked) {
    div.innerHTML =
