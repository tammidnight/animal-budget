...
window.addEventListener("load", () => {
    ...
    if (cow.checked) {
        ...
        div.innerHTML = '<h2>"Fun animal Fact"</h2><p>"Cows spend around 40% of the time eating, which is normal since they consume around 45kg of food per day. They’re also very sociable and they even have best friends, with whom we suppose they share some of that huge amount of food. Otherwise it would be just rude. "</p>'
    ...
    if (crocodile.checked) {
        ...
        div.innerHTML = '<h2>"Fun animal Fact"</h2><p>"Crocodiles have the most sophisticated heart in the animal kingdom and they can choose the destination of the blood that flows throw it depending on what they need. They’re closely related to both dinosaurs and birds. It’s true, look it up If you don’t believe us."</p>'
    ...
    if (dog.checked) {
        ...
        div.innerHTML = '<h2>"Fun animal Fact"</h2><p>"Dogs can be left or right-pawed. You can fin out whether your dog is left or right-pawed by giving them their favourite toy and seeing which pay whey use first on it. Scientists believe dogs can experience jealousy when their owners give attention to other dogs. But if they look ashamed but they’re lying since they don’t experience that emotion. Liars."</p>'
    ...
    if (monkey.checked) {
        ...
        div.innerHTML = '<h2>"Fun animal Fact"</h2><p>"Some monkeys enjoy a relaxing hot bath, so the link between humans are monkeys is clear and irrefutable. There are a lot of different species, and they are very different between them. Some monkeys live on the ground, while others live in trees. Different monkey species eat a varietyof foods, such as fruit, insects, flowers, leaves and reptiles. Groups of monkeys are known as a tribe, troop or mission."</p>'
    ...
    if (panda.checked) {
        ...
        div.innerHTML = '<h2>"Fun animal Fact"</h2><p>"Giant pandas spend 10-16 hours a day feeding, mainly on bamboo. That’s why their throat has a special lining to protect it from  splinters. However bamboo doesn’t provide them with enough calories to accumulate fat and they don’t hibernate. That’s also the reason they don’t  usually compete with one another and they’re loners, they do not have the energy (or are they just lazy?)."</p>'
    ...
    if (penguin.checked) {
        ...
        div.innerHTML = '<h2>"Fun animal Fact"</h2><p>"A Penguin’s black and white plumage serves as camouflage while swimming. The black plumage on their back is hard to see from above, whilethe white plumage on their front looks like the sun reflecting off the surface  of the water when seen from below. Also, they have very fast metabolisms, so they poop every 20 min!"</p>'
    ...
    if (walrus.checked) {
        ...
        div.innerHTML = '<h2>"Fun animal Fact"</h2><p>"  Walrus are called the kings of the artic due to the fact that they can weight up to 1.5 tones, the weight of a small car!  They’re very social animals and the mostly use their tusks to for cutting through ice and getting out of the water, although they will use them against one another for protection or during mating season."</p>'
    ...
    if (whale.checked) {
        ...
        div.innerHTML = '<h2>"Fun animal Fact"</h2><p>"The whale is the largest animal to ever live, they can weight more than 150,000 kg, and they’re also one oldest (they can live around 200 years). They’re very social and sing to find food, communicating with one another or to find each other when they separate."</p>'
    ...
    if (zebra.checked) {
        ...
        div.innerHTML = '<h2>"Fun animal Fact"</h2><p>"Their stripes are as unique are humans’ fingerprints, and they serve as camouflage. They can stand six minutes after being born, walk 40 minutes after and are able to run an hour after birth. It totally puts us  humans to shame."</p>'
